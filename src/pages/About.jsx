...
function About() {
  return (
    <div style={{ fontFamily: "'Inter', sans-serif", color: "#111", backgroundColor: "#fff", overflowX: "hidden" }}>
      ...
      {/* HERO */}
      <section style={{ padding: "clamp(80px,10vw,120px) 8% clamp(50px,6vw,80px)", textAlign: "center", background: "linear-gradient(to bottom, #f9f9f9, #fff)" }}>
        ...
        <h1 style={{ fontSize: "clamp(40px,7vw,90px)", fontWeight: "900", margin: "0", letterSpacing: "-4px", lineHeight: "0.9" }}>
      ...
      <div style={{ width: "90%", margin: "0 auto", position: "relative" }}>
        ...
        <div style={{
          ...
          <p style={{ margin: "15px 0 0 0", fontWeight: "700", fontSize: "12px", textTransform: "uppercase" }}>
            — Master Weaver, Jamdani Studio
          </p>
        </div>
      </div>
      ...
      {/* MANIFESTO */}
      <section style={{
        padding: "clamp(80px,10vw,120px) 8%",
        display: "grid",
        ...
        <div>
          <h2 style={{ fontSize: "clamp(32px,5vw,42px)", fontWeight: "900", marginBottom: "30px", letterSpacing: "-1px" }}>
            The Soul of <br />Dhaka Threads
          </h2>
          ...
          <p style={{ fontSize: "18px", color: "#666", lineHeight: "1.8" }}>
            Our artisans are not workers; they are historians. Using techniques passed down through six generations, they manipulate natural fibers into textiles that breathe, move, and age with grace.
          </p>
        </div>

        <div style={{ position: "relative" }}>
          <img
            src="https://thekindcraft.com/content/images/size/w1200/2024/11/peru1_988.jpg"
     ...
     {/* ARTISANS GRID */}
<section style={{ padding: "clamp(80px,10vw,100px) 8%", background: "#111", color: "white" }}>
  
  <div style={{ textAlign: "center", marginBottom: "80px" }}>
    <h2 style={{ fontSize: "clamp(36px,6vw,48px)", fontWeight: "900" }}>
      The Hands Behind the Thread
    </h2>

    <p style={{ color: "#888", maxWidth: "600px", margin: "20px auto" }}>
      Meet the master craftsmen who bring our vision to life using century-old techniques.
    </p>
  </div>
  ...
  >
    {[
      ...
      <div key={i} style={{ textAlign: "center" }}>
        ...
        <h3 style={{ fontSize: "24px", fontWeight: "800", marginBottom: "5px" }}>
          {artisan.name}
        </h3>
      ...
      {/* PROCESS */}
      <section style={{ padding: "clamp(80px,10vw,120px) 8%" }}>
        <h2 style={{ fontSize: "clamp(32px,5vw,42px)", fontWeight: "900", marginBottom: "60px", textAlign: "center" }}>
        ...
        <div style={{
          ...
          {[/* steps unchanged */].map((item, i) => (
            <div key={i} style={{ padding: "30px", borderLeft: "1px solid #eee" }}>
              ...
              <h4 style={{ fontSize: "20px", fontWeight: "800", position: "relative", zIndex: 1 }}>
                {item.title}
              </h4>
      ...
      {/* IMPACT IMAGE */}
      <section style={{ padding: "0 8% clamp(60px,8vw,100px)" }}>
        <div style={{
          ...
          <div style={{
            ...
            <h2 style={{ fontSize: "clamp(32px,6vw,48px)", fontWeight: "900" }}>
              Empowering 250+ Families
            </h2>

            <p style={{ fontSize: "20px", maxWidth: "500px", margin: "20px auto" }}>
              Every purchase directly supports traditional weaving communities.
            </p>
          </div>
        </div>
      </section>
      ...
      {/* CTA */}
      <section style={{ padding: "clamp(80px,10vw,100px) 8% clamp(100px,12vw,150px)", textAlign: "center" }}>
        <h2 style={{ fontSize: "clamp(32px,5vw,42px)", fontWeight: "900", marginBottom: "40px" }}>
